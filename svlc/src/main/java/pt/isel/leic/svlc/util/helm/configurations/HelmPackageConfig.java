...
/**
 * Class representing configuration options for packaging Helm charts.
 */
@Deprecated
public class HelmPackageConfig {
    ...
    public void setSign(String keyUID, Path keyring) {
        this.sign = true;
        this.keyUID = keyUID;
    ...
    public Path getPassphraseFile() {
        return passphraseFile;
    }

    public void setPassphraseFile(Path passphraseFile) {
        this.passphraseFile = passphraseFile;
    }

    public boolean isPassphraseFile() {
