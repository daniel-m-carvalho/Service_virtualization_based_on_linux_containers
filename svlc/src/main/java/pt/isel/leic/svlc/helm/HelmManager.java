...
import pt.isel.leic.svlc.util.results.*;

import java.nio.file.Path;
import java.util.List;

import static pt.isel.leic.svlc.util.helm.HelmManagerUtil.*;
import static pt.isel.leic.svlc.util.results.Result.*;
...
public class HelmManager {
     ...
     */
    public String installChart(HelmInstallConfig config) {
     ...
     */
    public String upgradeChart(HelmUpgradeConfig config) {
     ...
     */
    public String uninstallChart(HelmUninstallConfig config) {
     ...
     */
    public List<String> listReleases(HelmListConfig config)  {
     ...
     */
    public List<String> lintChart(HelmLintConfig config) {
     ...
     */
    public String testChart(HelmTestConfig config) {
     ...
     */
    public String dependencyBuild(HelmDependencyConfig config){
     ...
     */
    public List<String> dependencyList(HelmDependencyConfig config){
     ...
     */
    public String dependencyUpdate(HelmDependencyConfig config){
     ...
     */
    public Helm packageChart(HelmPackageConfig config) {
    ...
    /**
     * Executes a Helm operation.
     * @param helmProc The Helm operation.
     * @param <T> The type of the result.
     * @return The result of the operation.
     */
    public static <T> Result<Failure, Success<T>> executeHelm(helmProc<T> helmProc) {
        try {
            return Right(new Success<>(helmProc.run()));
        } catch (Exception e) {
